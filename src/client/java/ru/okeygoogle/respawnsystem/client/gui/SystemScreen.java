...
public final class UiConfig {
    ...
    private Path path() {
        return FabricLoader.getInstance()
                .getConfigDir()
                .resolve("respawn-system-ui.properties");
    }
    ...
    public void save() {
        ...
        p.setProperty(
                "showGrid",
                Boolean.toString(showGrid)
        );

        p.setProperty(
                "gridSpacing",
                Integer.toString(gridSpacing)
        );
        ...
        p.setProperty(
                "playUiSounds",
                Boolean.toString(playUiSounds)
        );

        p.setProperty(
                "rgbCycle",
                Boolean.toString(rgbCycle)
        );

        p.setProperty(
                "rgbSpeed",
                Integer.toString(rgbSpeed)
        );
        ...
        try {
            ...
            try (
                ...
                p.store(
                        out,
                        "Respawn System UI — author: okeygoogle"
                );
            }
